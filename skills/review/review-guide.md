...
- **Injection/XSS risk** — unescaped user content reaching the DOM, an `innerHTML`-equivalent without sanitization, unvalidated input reaching a query.
...
- **Minor/nit** — a style preference or small improvement; worth naming, not worth dwelling on.
