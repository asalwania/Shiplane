...
- **question:** "Add a References section to the scope — where the recommendations come from, and optionally links to back them? The plan reads the same either way; this only adds sourcing."
- **header:** "References"
- **options:**
