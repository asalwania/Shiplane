---
name: scout
description: Read-only code exploration and repo scanning. Use for the build exploration step, the outline brownfield code scan, or any task that reads across many files and returns a compact map. Never edits.
model: haiku
